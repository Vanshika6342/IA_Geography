...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{l *{3}{Y}}
		...
		\hline
		Site 1 & 0.33 & 0.37 & 0.21 \\
		Site 2 & 0.35 & 0.27 & 0.26 \\
		Site 3 & 0.57 & 0.56 & 0.78 \\
		Site 4 & 0.81 & 0.80 & 0.55 \\
		Site 5 & 0.33 & 0.29 & 0.35 \\
		Site 6 & 0.15 & 0.12 & 0.17 \\
		Site 7 & 0.09 & 0.07 & 0.03 \\
		Site 8 & 0.21 & 0.13 & 0.10 \\
		\hline
	\end{tabularx}
	\caption{Velocity Analogue}
	\label{tab:velocity_raw}
\end{table}
